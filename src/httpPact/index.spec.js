...
describe('Pact', function () {
    ...
    before(function () {
        // Stub out pact-core
        var manager = ts_mock_imports_1.ImportMock.mockClass(pact_core_1.default, 'createServer');
        manager.mock('createServer', function () { });
    });
    beforeEach(function () {
        pact = Object.create(_1.Pact.prototype);
        pact.opts = fullOpts;
    });
    afterEach(function () {
    ...
    describe('#setup', function () {
        ...
        describe('when server is not properly configured', function () {
            describe('and pact-core is unable to start the server', function () {
                it('returns a rejected promise', function () { return __awaiter(void 0, void 0, void 0, function () {
                    var p;
                    return __generator(this, function (_a) {
                        p = new _1.Pact(fullOpts);
                        p.server = {
                            start: function () { return Promise.reject(new Error('pact-core error')); },
                            options: { port: 1234 },
                        };
                        return [2 /*return*/, expect(p.setup()).to.eventually.be.rejectedWith('pact-core error')];
                    });
                }); });
            });
        });
    ...
    describe('#verify', function () {
        ...
        describe('when pact verification is unsuccessful', function () {
            it('throws an error', function () {
                var removeInteractionsStub = sinon_1.default
                    .stub(mockService_1.MockService.prototype, 'removeInteractions')
                    .resolves('removeInteractions');
                pact.mockService = {
                    verify: function () { return Promise.reject(new Error('not verified!')); },
    ...
    describe('#finalize', function () {
        describe('when writing Pact is successful', function () {
            it('returns a successful promise and shuts down down the mock server', function () {
                pact.mockService = {
                    ...
                    removeInteractions: sinon_1.default.stub(),
                };
                pact.server = {
        ...
        describe('when writing Pact is unsuccessful', function () {
            it('throws an error and shuts down the server', function () {
                ...
                var deleteStub = sinon_1.default
                    .stub(PactServer.prototype, 'delete')
                    .resolves();
        ...
        describe('when writing pact is successful and shutting down the mock server is unsuccessful', function () {
            it('throws an error', function () {
                pact.mockService = {
                    writePact: sinon_1.default.stub(),
                    removeInteractions: sinon_1.default.stub(),
                };
                pact.server = {
