    ...
    describe('#given', function () {
        ...
        describe('without provider state', function () {
            it('creates Interaction when blank', function () {
                var actual = new interaction_1.Interaction().uponReceiving('r').given('').json();
    ...
    describe('#withRequest', function () {
        ...
        describe('query type', function () {
            ...
            it('is passed with matcher', function () {
                ...
                expect(new interaction_1.Interaction().uponReceiving('request').withRequest(request).json()
            ...
            it('is passed with array', function () {
                ...
                expect((_a = new interaction_1.Interaction().uponReceiving('request').withRequest(request).json()
