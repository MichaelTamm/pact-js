...
var MockService = /** @class */ (function () {
    ...
    port, host, ssl, pactfileWriteMode) {
        ...
        this.baseUrl = "".concat(this.ssl ? 'https' : 'http', "://").concat(this.host, ":").concat(this.port);
        this.pactDetails = {
    ...
    MockService.prototype.addInteraction = function (interaction) {
        return this.request.send(request_1.HTTPMethods.POST, "".concat(this.baseUrl, "/interactions"), JSON.stringify(interaction.json()));
    };
    /**
    ...
    MockService.prototype.removeInteractions = function () {
        return this.request.send(request_1.HTTPMethods.DELETE, "".concat(this.baseUrl, "/interactions"));
    };
    /**
    ...
    MockService.prototype.verify = function () {
        return this.request.send(request_1.HTTPMethods.GET, "".concat(this.baseUrl, "/interactions/verification"));
    };
    /**
    ...
    MockService.prototype.writePact = function () {
        return this.request.send(request_1.HTTPMethods.POST, "".concat(this.baseUrl, "/pact"), JSON.stringify(this.pactDetails));
    };
    return MockService;
}());
