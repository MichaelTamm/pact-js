 ...
 * @module Message
 */
export declare type MessageConsumer = (m: Message) => Promise<unknown>;
export declare type MessageFromProvider = unknown;
export declare type MessageFromProviderWithMetadata = {
 ...
 * @module Message
 */
export declare type MessageProvider = (m: MessageDescriptor) => Promise<MessageFromProvider | MessageFromProviderWithMetadata> | MessageFromProvider | MessageFromProviderWithMetadata;
export interface MessageProviders {
    [name: string]: MessageProvider;
}
export interface StateHandlers {
    [name: string]: (state: string, params?: {
        [name: string]: string;
    }) => Promise<unknown>;
}
